...
class BookingServiceImplIntegrationTest {
    ...
    @Test
    void createBooking_ValidBooking_ShouldCreateBooking() {
    ...
    @Test
    void approveBooking_OwnerApproves_ShouldUpdateStatus() {
        BookingCreateDto bookingDto = new BookingCreateDto(
                item.getId(),
                LocalDateTime.now().plusDays(1),
                LocalDateTime.now().plusDays(2)
    ...
    @Test
    void getUserBookings_UserWithBookings_ShouldReturnBookings() {
        BookingCreateDto bookingDto = new BookingCreateDto(
                item.getId(),
                LocalDateTime.now().plusDays(1),
                LocalDateTime.now().plusDays(2)
    ...
    @Test
    void getOwnerBookings_OwnerWithBookings_ShouldReturnBookings() {
        BookingCreateDto bookingDto = new BookingCreateDto(
                item.getId(),
                LocalDateTime.now().plusDays(1),
                LocalDateTime.now().plusDays(2)
